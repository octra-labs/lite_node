...
sh -n controls/state_sync_source.sh
...
PYTHONPATH="$ROOT/controls/lib" PYTHONDONTWRITEBYTECODE=1 python3 -c 'import validator_bundle, validator_config, validator_enroll, validator_guard, validator_process, validator_recover, validator_rpc, validator_state_sync_source, validator_status'
