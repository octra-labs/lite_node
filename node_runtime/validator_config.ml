...
let light_scheduled_of_driver ~chain_id = function
  | None -> None
  | Some cfg ->
      ...
      | Ok active_config ->
        ...
        begin
          ...
          | Ok pending_config ->
            ...
            in
            let scheduled_driver_config = scheduled_driver_config_raw in
            let light_scheduled_validator_set =
              light_scheduled_of_driver ~chain_id scheduled_driver_config
            in
